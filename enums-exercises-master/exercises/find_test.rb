...
class FindTest < Minitest::Test
  ...
  def test_no_waldo
    ...
    found = words.find{|x|x.include?("waldo")}
  ...
  def test_find_first_word_starting_with_q
    ...
    found = words.find{|x|x.include?("q")}
  ...
  def test_find_first_word_ending_with_er
    ...
    found = words.find{|x|x.include?("er")}
